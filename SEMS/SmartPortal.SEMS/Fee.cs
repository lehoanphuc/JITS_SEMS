...
namespace SmartPortal.SEMS
{
    public class Fee
    {
        ...
        public DataSet SearchContractFee(string contractno, string trancode, string feeid, string ccyid, string fullname, string status , string branchid, string feetype, int recPerPage, int recIndex, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC

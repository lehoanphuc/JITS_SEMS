...
namespace SmartPortal.SEMS
{
    public class Contract
    {
        ...
        public DataSet GetContractByCondition(string contractno, string custname, string usercreate, string createdate, string enddate, string contracttype, string status, string licenseid, string custcode, string PhoneNo, ref string errorCode, ref string errorDesc)
        {
            return GetContractByCondition(contractno, custname, usercreate, createdate, enddate, contracttype, status, licenseid, custcode, PhoneNo, 15, 0, ref errorCode, ref errorDesc);
        }
        public DataSet GetContractByCondition(string contractno, string custname, string usercreate, string createdate, string enddate, string contracttype, string status, string licenseid, string custcode, string PhoneNo, int MaxiMumRows, int StartRowIndex, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC

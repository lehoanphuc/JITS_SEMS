...
namespace SmartPortal.SEMS
{
    public class Bank
    {
        ...
        #region Insert bank
        public DataSet Insert(string CountryID, string BankCode, string BankName, string BankNameLA, string BankNameCN, string ShortName, string Address, string UserCreated, ref string errorCode, ref string errorDesc)
        {
            try
            {
                Hashtable hasInput = new Hashtable();
                Hashtable hasOutput = new Hashtable();
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "SEMSCBTBANKINSERT");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIDVALUE);
                hasInput.Add("CountryID", CountryID);
                hasInput.Add("BankCode", BankCode);
                hasInput.Add("BankName", BankName);
                hasInput.Add("BankNameLA", BankNameLA);
                hasInput.Add("BankNameCN", BankNameCN);
                hasInput.Add("ShortName", ShortName);
                hasInput.Add("Address", Address);
        ...
        public DataSet InsertCBTCCYID(int bankID, string CCYID, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                Hashtable hasOutput = new Hashtable();
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "CBTCCYIDINSERT");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIDVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.SOURCETRANREF, SmartPortal.Constant.IPC.SOURCETRANREFVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.TRANDESC, "INSERT CBT BANK CCYID");
                hasInput.Add(SmartPortal.Constant.IPC.REVERSAL, "N");
        ...
        public DataSet SearchCBTBankByCondition(string bankid, string countryid, string bankcode, string bankname, int pagesize, int pageindex, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "SEMSCBTBANKSEARCH");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIDVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.SOURCETRANREF, SmartPortal.Constant.IPC.SOURCETRANREFVALUE);
        ...
        public DataSet DeleteCBTBank(string BankID, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "SEMSCBTBANKDELETE");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIDVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.SOURCETRANREF, SmartPortal.Constant.IPC.SOURCETRANREFVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.TRANDESC, "DELETE BANK");
                hasInput.Add(SmartPortal.Constant.IPC.REVERSAL, "N");
        ...
        public DataSet DeleteCBTCCYID(string BankID, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "SEMSCBTCCYIDDELETE");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIDVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.SOURCETRANREF, SmartPortal.Constant.IPC.SOURCETRANREFVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.TRANDESC, "DELETE CCYID BY BANK");
                hasInput.Add(SmartPortal.Constant.IPC.REVERSAL, "N");
        ...
        public DataSet UpdateCBTBank(string bankid, string countryid, string bankCode, string bankName, string bankNameLA, string bankNameCN, string shortName, string address, string user_modifies, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "SEMSCBTBANKUPDATE");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIDVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.SOURCETRANREF, SmartPortal.Constant.IPC.SOURCETRANREFVALUE);
                ...
                hasInput.Add(SmartPortal.Constant.IPC.BANKNAME, bankName);
                hasInput.Add("BANKNAMELA", bankNameLA);
                hasInput.Add("BANKNAMECN", bankNameCN);
        ...
        #region GET DETAILS BANK BY BANKID
        public DataSet GetCBTBankDetailsByID(string bankID, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "CBTBANKDETAILS");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIDVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.SOURCETRANREF, SmartPortal.Constant.IPC.SOURCETRANREFVALUE);

...
public partial class Widgets_SEMSContractReview_RegisterContract : System.Web.UI.Page
{
    ...
    void BindData1()
    {
        ...
        string str = "<div><img src='/Images/favlist2.png' style='height:70px;font-size: 14px;' /><br/><br/></div>";
        str += ViewState["tmpl"].ToString();
        str += "<div style='font-size: 14px;'><br/><p><a href='https://www.phongsavanhbank.com/' target='blank'>https://www.phongsavanhbank.com/</a></p><span style='font-weight:bold;'>" + Resources.labels.camonquykhachdasudungdichvucuaABank + "!	</span></div>";

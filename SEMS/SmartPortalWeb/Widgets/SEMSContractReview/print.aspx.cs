    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!IsPostBack)
            {
                ...
                {
                    string str = "<div><img src='https://www.phongsavanhbank.com/psv/allpages/images/psvb_logo.png' style='height:70px;' /><br/><br/></div>";
                    str += Session["tmpl"].ToString();
                    str += "<div><br/><p><a href='https://www.phongsavanhbank.com/' target='blank'>https://www.phongsavanhbank.com/</ a></p><span style='font-weight:bold;'>" + Resources.labels.AbankthankyouforusingAYAebankingservices + "!	</span></div>";

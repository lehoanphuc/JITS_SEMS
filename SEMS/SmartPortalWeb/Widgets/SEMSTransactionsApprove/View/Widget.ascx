    ...
    <ContentTemplate>
        ...
        <div>
            ...
            <div id="divResult">
                ...
                <asp:GridView ID="gvcontractList" CssClass="table table-hover" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" Width="100%" AllowPaging="True" AutoGenerateColumns="False" OnRowDataBound="gvcontractList_RowDataBound" PageSize="15" OnPageIndexChanging="gvcontractList_PageIndexChanging"  OnRowCommand="gvcontractList_RowCommand">

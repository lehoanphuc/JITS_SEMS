    ...
    private void SendInfoLogin(string contractNo)
    {
        try
        {
            ...
            foreach (DataRow row in userTable.Rows)
            {
                ...
                strAttachment += "<div><br/><p><a href='https://www.phongsavanhbank.com/ target='blank'>https://www.phongsavanhbank.com/</a></p><span style='font-weight:bold;'>" + Resources.labels.AbankthankyouforusingAYAebankingservices + "!	</span></div>";
                PhoneNo = PhoneNoMB;

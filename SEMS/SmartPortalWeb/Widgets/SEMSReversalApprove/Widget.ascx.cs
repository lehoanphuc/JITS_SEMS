  ...
  void BindData()
    {
        try
        {
            ...
            object[] searchObject = new object[] { Utility.KillSqlInjection(txtrequestID.Text.Trim()), Utility.KillSqlInjection(ddStatus.SelectedValue), Utility.KillSqlInjection(txtFrom.Text.Trim()), Utility.KillSqlInjection(txtTo.Text.Trim()) ,GridViewPaging.pageIndex * GridViewPaging.pageSize, GridViewPaging.pageSize };

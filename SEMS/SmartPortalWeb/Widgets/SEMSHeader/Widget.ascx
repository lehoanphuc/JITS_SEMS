        ...
        <div class="container">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="nav-link d-flex justify-content-center align-items-center" href="<%= SmartPortal.Common.Encrypt.EncryptURL("?p=129") %>">
                    <img src="https://www.phongsavanhbank.com/psv/allpages/images/psvb_logo.png" />
            </div>
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item">
                        <a class="nav-link d-flex justify-content-center align-items-center" href="<%= SmartPortal.Common.Encrypt.EncryptURL(SmartPortal.Common.Utilities.Utility.LinkMultiLang(false)+"l=lo-LA") %>">
                            <img src="../../Images/lo-LA.png" class="nav-icon-title">
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex justify-content-center align-items-center" href="<%= SmartPortal.Common.Encrypt.EncryptURL(SmartPortal.Common.Utilities.Utility.LinkMultiLang(false)+"l=zh-CN") %>">
                            <img src="/Images/sh-CN.png" class="nav-icon-title">
                        </a>
                    </li>

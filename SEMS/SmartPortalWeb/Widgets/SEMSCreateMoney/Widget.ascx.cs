...
public partial class Widgets_SEMSCloseWalletAccount_Widget : WidgetBase
{
    ...
    private void PrintVoucher()
    {
        ...
        try
        {
            ...
            str += "<img src = 'https://www.phongsavanhbank.com/psv/allpages/images/psvb_logo.png' style = 'height:70px;' />";
            str += "<br/>";
            str += "<br/>";
            str += "</td>";
            str += "</tr>";
            ...
            str += "<br/>";
            str += "<hr/>";
            str += "<p><a href='https://www.phongsavanhbank.com/' target='blank'>https://www.phongsavanhbank.com/</a></p>";
            str += "<span style='font-weight:bold;'>";
            str += "Thank you for using services of PSVBANK!";
            str += "</span>";
            str += "</td>";
            str += "</tr>";
            str += "</table>";

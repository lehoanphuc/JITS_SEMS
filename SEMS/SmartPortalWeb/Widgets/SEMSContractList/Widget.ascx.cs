...
public partial class Widgets_SEMSContractList_Widget : WidgetBase
{
    ...
    void BindData()
    {
        try
        {
            ...
            dtContr = new SmartPortal.SEMS.Contract().GetContractByCondition(txtContractCode.Text.Trim(), txtCustName.Text.Trim(), txtopenPer.Text.Trim(), txtOpenDate.Text.Trim(), txtEndDate.Text.Trim(), ddlUserType.SelectedValue, ddlStatus.SelectedValue, txtlicenseid.Text.Trim(), txtcustcode.Text.Trim(), txtPhone.Text.Trim(), gvcontractList.PageSize, gvcontractList.PageIndex * gvcontractList.PageSize, ref IPCERRORCODE, ref IPCERRORDESC);
            if (IPCERRORCODE == "0")
            {
    ...
    protected void SortGridView(string sortExpression, string direction)
    {
        try
        {
            ...
            ds = new SmartPortal.SEMS.Contract().GetContractByCondition(Utility.KillSqlInjection(txtContractCode.Text.Trim()), Utility.KillSqlInjection(txtCustName.Text.Trim()), Utility.KillSqlInjection(txtopenPer.Text.Trim()), Utility.KillSqlInjection(txtOpenDate.Text.Trim()), Utility.KillSqlInjection(txtEndDate.Text.Trim()), ddlUserType.SelectedValue, ddlStatus.SelectedValue, txtlicenseid.Text.Trim(), txtcustcode.Text.Trim(), txtPhone.Text.Trim(), gvcontractList.PageSize, gvcontractList.PageIndex * gvcontractList.PageSize, ref IPCERRORCODE, ref IPCERRORDESC); ;

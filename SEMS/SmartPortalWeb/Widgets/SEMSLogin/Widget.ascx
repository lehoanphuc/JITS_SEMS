        ...
        <div class="bg-brand-gradient">
            <div class="blankpage-form-field">
                ...
                <div class="blankpage-footer text-center">
                    <asp:LinkButton ID="lbForgotPassword" OnClick="lbForgotPassword_OnClick" Text='<%$ Resources:labels, quenmatkhau %>' runat="server"></asp:LinkButton>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="<%= SmartPortal.Common.Encrypt.EncryptURL(SmartPortal.Common.Utilities.Utility.LinkMultiLang(true)+"l=lo-LA") %> "><img src="../../Images/lao_flag_icon.png" /></a>&nbsp;&nbsp;

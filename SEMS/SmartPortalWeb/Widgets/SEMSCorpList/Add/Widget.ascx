                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <asp:DropDownList ID="ddlProduct" runat="server" Enabled="True" CssClass="form-control select2 infinity">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <asp:DropDownList ID="ddlCorpType" runat="server" Enabled="True" CssClass="form-control select2 infinity">
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label required"><%=Resources.labels.dungpolicy %></label>
                                                    <div class="col-sm-8">
                                                        <asp:DropDownList ID="ddlPolicyMB" runat="server" CssClass="form-control select2 infinity" Width="100%" AutoPostBack="true"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>

                                ...
                                <div class="row">
                                    <div class="col-sm-10 col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="col-sm-4 col-xs-12 control-label"><%=Resources.labels.TransactionDate %></label>
                                                    <div class="col-sm-8 col-xs-12">
                ...
                <asp:GridView ID="gvLTWA" CssClass="table table-hover white-space" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText='Delete'>
                            <ItemTemplate>
                                <asp:LinkButton ID="hpDelete" runat="server" CssClass="btn btn-secondary" CommandName='<%#IPC.ACTIONPAGE.DELETE %>' CommandArgument='<%#Eval("IPCTRANSID")%>' OnClientClick="Loading(); return Confirm();">Delete</asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                    </Columns>
